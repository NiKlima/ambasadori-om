...
update profiles set
  ...
  achievements = array['Berlin Marathon 2024 — finisher 3:42', 'Chișinău Half Marathon 2023 — top 10 women', 'Coach of the Year — Bigsport 2023', 'IAAF Coaching Level 2'],
...
update profiles set
  ...
  achievements = array['CrossFit L2 trainer', 'Open 2024 — Quarterfinalist', 'Coach since 2018 · 200+ athletes trained', 'Boxing certified — Federation level'],
...
update profiles set
  ...
  achievements = array['RYT-500 certified · Rishikesh', 'Hatha & Vinyasa lead at Jiva', '8 years teaching · 1000+ classes', 'Pranayama specialist'],
...
update profiles set
  ...
  achievements = array['IPF Open 2023 — silver -93kg', 'Squat 240kg · Bench 160kg · Deadlift 280kg', 'Coach since 2019 · 50+ athletes', 'Sports Nutrition certified'],
...
update profiles set
  ...
  achievements = array['Pilates Method Alliance certified', 'Reformer specialist · 6 years at Alexia', 'Former competitive swimmer · regional medalist', 'Pre/post-natal pilates qualified'],
...
update profiles set
  ...
  achievements = array['Ironman 70.3 sub-5h · 2024', 'Full Ironman finisher · 2021', 'Triathlon Federation certified coach', 'Open water swim instructor'],
...
update profiles set
  ...
  achievements = array['NSCA-CFT certified', 'Functional Movement Screen Level 2', 'Pre/post-natal training certified', '8 years coaching · 300+ clients'],
...
update profiles set
  ...
  achievements = array['Regional amateur champion 2014', 'AIBA Level 1 coach', '30+ amateur fighters trained', 'Boxing-conditioning specialist'],
...
update profiles set
  ...
  achievements = array['Yin Yoga 100h · Yoga Alliance', 'Restorative Yoga certified', 'Yoga Nidra specialist', 'Trauma-informed teaching · ongoing'],
...
update profiles set
  ...
  achievements = array['Comprehensive Pilates · 600h', 'Former contemporary dancer', 'Mat & Reformer certified', 'Studio owner since 2021'],
